...
<?php $this->insert("widgets/users/sidebar", ["app"=>$app, "user"=>$user]); ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/users/user/{$user->id}"); ?>" method="post">
                ...
                <div class="label_g2">
                    <label class="label">
                        ...
                        <select name="level" required>
                            ...
                            <option <?= $select(10); ?> value="10">Super Admin</option>
                        </select>
                    </label>
                ...
                <div class="app_form_footer">
                    ...
                    <?php if($user->id != \Source\Models\Auth::user()->id && $user->level < 5): ?>
