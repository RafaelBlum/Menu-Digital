...
<?php $this->insert("widgets/product/sidebar", ["app"=>$app, "category"=> $category]); ?>

<section class="dash_content_app">
    <?php if (!$category): ?>
        <header class="dash_content_app_header">
            <h2 class="icon-plus-circle">Nova Categoria de produtos</h2>
        </header>
    ...
    <?php else: ?>
        <header class="dash_content_app_header">
            ...
            <a class="icon-link btn btn-green" href="<?= url("/products/em/{$category->uri}"); ?>" target="_blank"
               title="">Ver no site</a>
        </header>
