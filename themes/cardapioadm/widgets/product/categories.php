...
<?php $this->insert("widgets/product/sidebar", ["app"=>$app, "categories"=> $categories]); ?>

<section class="dash_content_app">
    <header class="dash_content_app_header">
        <h2 class="icon-pencil-square-o">Categorias do cardápio</h2>
                    ...
                    <?php foreach ($categories as $category):
                        ...
                        <article class="radius">
                            ...
                            <div class="info">
                                <h3 class="title">
                                    <?= $category->title; ?>
                                    [ <b><?= $category->typeCategory('product')->count(); ?> artigos aqui</b> ]
                                </h3>
                                <p class="desc"><?= $category->description; ?></p>

                                <div class="actions">
                                    <a class="icon-pencil btn btn-blue" title=""
                                       href="<?= url("/admin/products/category/{$category->id}"); ?>">Editar</a>

                                    <a class="icon-trash-o btn btn-red" href="#" title=""
                                       data-post="<?= url("/admin/products/category"); ?>"
                                       data-action="delete"
